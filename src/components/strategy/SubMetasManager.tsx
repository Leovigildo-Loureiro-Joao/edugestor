//// components/estrategia/SubMetasManager
...
//      });
//      onUpdate();
//      showAlert({ type: 'success', title: 'Sub-meta adicionada com sucesso!' });
//    } catch (error) {
//      showAlert({ type: 'error', title: 'Erro ao adicionar sub-meta' });
//    }
//  };
//
...
//      onUpdate();
//      showAlert({ type: 'success', title: 'Sub-meta removida com sucesso!' });
//  };
//
...
//      onUpdate();
//      showAlert({ type: 'success', title: 'Status atualizado!' });
//    } catch (error) {
//      showAlert({ type: 'error', title: 'Erro ao atualizar status' });
//    }
//  };
//
//  return (

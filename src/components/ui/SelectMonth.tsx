    ...
    return (
        <div className="relative">
            <button
                ...
                className="w-full p-3 border border-gray-300 rounded-lg bg-white hover:border-gray-400 focus:ring-2 focus:ring-green-500 focus:border-green-500 flex items-center justify-between transition-colors"
            >
                <div className="flex items-center gap-2">
                    <FiCalendar className="text-gray-400" />
                    <span className="text-gray-700">{formatarMesesSelecionados()}</span>
                </div>
                        ...
                        {mesesDisponiveis.map(mes => (
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    <div className="font-medium text-gray-900">{mes.nome}</div>
